...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_staff = models.BooleanField(
        ...
        default=False,
        help_text = ugettext_lazy('Designates whether this user can log in this site')
    )
    is_active = models.BooleanField(
        ugettext_lazy('active'),
        default=True,
        help_text = ugettext_lazy('Designates whether this user should be treated as active. Unselect this instead of deleting account')
    )
