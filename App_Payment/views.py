...
def payment(request):
    ...
    store_id = 'abc603f9f67683b9'
    API_key = 'abc603f9f67683b9@ssl'
    ...
    mypayment.set_product_integration(total_amount=Decimal(order_total), currency='BDT', product_category='Mixrd', product_name=order_items, num_of_item=order_items_count, shipping_method='Courier', product_profile='None')
...
def complete(request):
    if request.method == 'POST' or request.method == 'post':
        ...
        if status == 'VALID':
            ...
            messages.success(request, f"Your Payment Completed Successfully! Page will be redirected soon")
